...
const navigationMenuTriggerStyle = cva(
  'cursor-pointer group inline-flex h-9 w-max items-center justify-center rounded-md bg-white/5 backdrop-blur-md px-4 py-2 text-sm font-medium text-white hover:bg-white/10 hover:text-white focus:bg-white/10 focus:text-white disabled:pointer-events-none disabled:opacity-50 data-[active=true]:bg-white/10 data-[state=open]:bg-white/10 data-[active=true]:text-white ring-ring/10 transition-[color,box-shadow,background-color] focus-visible:ring-4 focus-visible:outline-1 border border-white/10',
);
...
function NavigationMenuLink({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        'hover:bg-white/10 hover:text-white focus:bg-white/10 focus:text-white data-[active=true]:bg-white/10 data-[active=true]:text-white ring-ring/10 flex flex-col gap-1 rounded-md p-2 text-sm transition-[color,box-shadow,background-color] focus-visible:ring-4 focus-visible:outline-1',
        className,
      )}
      {...props}
    />
