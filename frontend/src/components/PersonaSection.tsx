  ...
  ({ onSelect, activePersona }, ref) => {
    ...
    return (
      <section ref={ref} className="w-full min-h-screen flex flex-col items-center justify-center py-32 px-4 z-10">
        <h2 className="font-display text-4xl md:text-6xl text-textPrimary mb-16 tracking-tight">
          ...
          {personas.map(p => {
            ...
            return (
              <div
                ...
                className={`
                  p-8 rounded-2xl cursor-pointer border backdrop-blur-md transition-all duration-300
                  ${isActive 
                ...
                `}
              >
                <h3 className="font-display text-2xl mb-4 text-textPrimary">{p.title}</h3>
